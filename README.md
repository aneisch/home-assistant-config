...
[![HA Version](https://img.shields.io/badge/Running%20Home%20Assistant%20-2023.6.0b6%20(Out%20of%20Date)-Red)](https://github.com/home-assistant/home-assistant/releases/latest)
...
Lines of Home Assistant YAML | 7374
...
Entities in the [`sensor`](https://www.home-assistant.io/components/sensor) domain | 341
Entities in the [`button`](https://www.home-assistant.io/components/button) domain | 93
Entities in the [`lock`](https://www.home-assistant.io/components/lock) domain | 2
Entities in the [`number`](https://www.home-assistant.io/components/number) domain | 62
