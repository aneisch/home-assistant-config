...
[![HA Version](https://img.shields.io/badge/Running%20Home%20Assistant-2026.8.3%20(Latest)-brightgreen)](https://github.com/home-assistant/home-assistant/releases/latest)
...
Description | value
-- | --
Lines of ESPHome YAML | 6697
Lines of Home Assistant YAML | 13674
[Integrations](https://www.home-assistant.io/integrations/) in use | 82
...
Entities in the [`automation`](https://www.home-assistant.io/components/automation) domain | 147
Entities in the [`binary_sensor`](https://www.home-assistant.io/components/binary_sensor) domain | 212
Entities in the [`button`](https://www.home-assistant.io/components/button) domain | 104
...
Entities in the [`input_number`](https://www.home-assistant.io/components/input_number) domain | 12
...
Entities in the [`media_player`](https://www.home-assistant.io/components/media_player) domain | 26
Entities in the [`notify`](https://www.home-assistant.io/components/notify) domain | 7
...
Entities in the [`script`](https://www.home-assistant.io/components/script) domain | 59
Entities in the [`select`](https://www.home-assistant.io/components/select) domain | 23
Entities in the [`sensor`](https://www.home-assistant.io/components/sensor) domain | 892
...
Entities in the [`switch`](https://www.home-assistant.io/components/switch) domain | 221
...
Entities in the [`valve`](https://www.home-assistant.io/components/valve) domain | 3
Entities in the [`weather`](https://www.home-assistant.io/components/weather) domain | 1
Entities in the [`zone`](https://www.home-assistant.io/components/zone) domain | 8
**Total state objects** | **2114**
...
**Integration**:<br>
[3dg1luk43/ha_creality_ws](https://github.com/3dg1luk43/ha_creality_ws)<br>
...
[Caymanwent/ha-sunrise-soc-forecast](https://github.com/Caymanwent/ha-sunrise-soc-forecast)<br>
