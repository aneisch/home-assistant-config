...
[![HA Version](https://img.shields.io/badge/Running%20Home%20Assistant-2021.4.6%20(Latest)-brightgreen)](https://github.com/home-assistant/home-assistant/releases/latest)
...
- ZHA using [CC2531](https://amzn.to/2L5xKNB) running zigbee2mqtt firmware with various devices
  ...
  - 10 The Home Depot Ecosmart-ZBT-A19-CCT-Bulb
...
Lines of Home Assistant YAML | 5181
[Integrations](https://www.home-assistant.io/integrations/) in use | 28
...
Entities in the [`automation`](https://www.home-assistant.io/components/automation) domain | 65
Entities in the [`binary_sensor`](https://www.home-assistant.io/components/binary_sensor) domain | 47
...
Entities in the [`light`](https://www.home-assistant.io/components/light) domain | 35
