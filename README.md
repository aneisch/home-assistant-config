...
[![HA Version](https://img.shields.io/badge/Running%20Home%20Assistant-2023.6.2%20(Latest)-brightgreen)](https://github.com/home-assistant/home-assistant/releases/latest)
...
Description | value
-- | --
Lines of ESPHome YAML | 2381
Lines of Home Assistant YAML | 7378
...
Entities in the [`input_boolean`](https://www.home-assistant.io/components/input_boolean) domain | 25
...
Entities in the [`binary_sensor`](https://www.home-assistant.io/components/binary_sensor) domain | 92
...
Entities in the [`sensor`](https://www.home-assistant.io/components/sensor) domain | 344
...
Entities in the [`button`](https://www.home-assistant.io/components/button) domain | 99
Entities in the [`lock`](https://www.home-assistant.io/components/lock) domain | 2
Entities in the [`number`](https://www.home-assistant.io/components/number) domain | 63
