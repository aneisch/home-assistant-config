...
`,jt=(e,t)=>e.length>t?e.slice(0,t)+"...":e,Rt=(e,t,n)=>{const r=[...e.matchAll(/\[\[ ([a-zA-Z0-9_.-]*) \]\]/g)].map(e=>e[1]);return null==r||r.forEach(r=>{const o=`[[ ${r} ]]`,i=t[r];if(null!=i)e=e.replace(o,i);else if(null!=n&&r.startsWith(n.entity_id))if(n.entity_id==r)e=e.replace(o,n.entity_id);else{const t=r.replace(n.entity_id,"").split(".").slice(1);let i=n;for(const e of t){if(null==i||null==i[e]){i=void 0;break}i=i[e]}null!=i&&"object"!=typeof i&&(e=e.replace(o,String(i)))}}),e};console.info("%c uptime-card \n    0.4.0    ","color: white; background-color: #C6B145; font-weight: 700;"),window.customCards=window.customCards||[],window.customCards.push({type:"uptime-card",name:"Uptime Card",description:"The uptime card show you the history of your binary sensors in a cool way."});let Bt=class extends Ie{static async getConfigElement(){return document.createElement("uptime-card-editor")}static getStubConfig(){return{}}set hass(e){this._hass=e,this.sensor=e.states[this.config.entity],this.updateData()}get actions(){return["more-info","url","navigate","toggle","call-service","fire-dom-event"]}setConfig(e){if(!e)throw new Error("Invalid configuration !");this.config=Object.assign(Object.assign(Object.assign({},Ee),e),{color:Object.assign(Object.assign({},Te),e.color),alias:Object.assign({},e.alias),show:Object.assign(Object.assign({},Ae),e.show),bar:Object.assign(Object.assign({},De),e.bar),tooltip:Object.assign(Object.assign({},$e),e.tooltip),tap_action:Object.assign(Object.assign({},Me),e.tap_action),alignment:Object.assign(Object.assign({},je),e.alignment)}),this.updateData()}shouldUpdate(e){return!!this.config&&function(e,t,n){if(t.has("config")||n)return!0;if(e.config.entity){var r=t.get("hass");return!r||r.states[e.config.entity]!==e.hass.states[e.config.entity]}return!1}(this,e,!1)}firstUpdated(e){this.updateData()}connectedCallback(){super.connectedCallback(),this.config.update_interval&&(this.interval=setInterval(()=>this.updateData(),1e3*this.config.update_interval))}disconnectedCallback(){this.interval&&clearInterval(this.interval),super.disconnectedCallback()}async updateData(){if(null==this.config||null==this._hass)return;const{entity:e,hours_to_show:t}=this.config;if(this.sensor=this._hass.states[this.config.entity],null==this.sensor)return;const n=await this.getCache(e);null!=n&&(this.cache=n);const r=(new Date).getTime();let o;const i=null==n||n.hoursToShow<t,s=i?this.getMinimumDate():n.lastFetched,a=new Date(s),c=new Date;if(c.getTime()-a.getTime()<1e4)return;const l=await this.fetchRecent(e,a,c),u=i?l:[...n.points,...l],d=u.findIndex(e=>e.x>this.getMinimumDate()),h=0==d?u:u.slice(d-1),f=this.cleanPoints(h);if(f.length>0)o={points:f,lastFetched:r,lastChanged:f[f.length-1].x,hoursToShow:t};else{const e=new Date(this.sensor.last_changed).getTime();o={points:[{x:e,y:this.sensor.state}],lastFetched:r,lastChanged:e,hoursToShow:t}}await this.setCache(e,o),this.cache=o}async getCache(e){const t=await $t.getItem(e);return null==t?(console.warn(`Can't load the key ${e} from cache.`),null):(n=t,JSON.parse(n));var n}async setCache(e,t){return $t.setItem(e,(n=t,JSON.stringify(n)));var n}isOk(e){const{ok:t,ko:n,entity:r}=this.config;return null==e?void 0:t==e||n!=e&&(null==t&&null==n?null!=r&&r.startsWith("binary_sensor")?"on"==e||"off"!=e&&void 0:void 0:null==t)}findBarPeriod(e){const{bar:t}=this.config,n=this.getUptimeSize()/t.amount,r=(new Date).getTime()-(t.amount-1-e)*n;return{from:r-n+1,to:r}}findBarRepartition(e){const t={ok:0,ko:0,none:100};if(null==this.cache)return t;const n=this.cache.points.findIndex(t=>t.x>=e.from),r=this.cache.points.findIndex(t=>t.x>e.to);let o;if(0==this.cache.points.length)return t;if(-1==n)o=[this.cache.points[this.cache.points.length-1]];else{if(0==n&&0==r)return t;{const e=0==n?0:1,t=-1==r?this.cache.points.length:r;o=this.cache.points.slice(n-e,t)}}const i={ok:0,ko:0,none:0},s=e.to-e.from;for(let t=0;t<o.length;t++){const n=(o[t+1]?o[t+1].x:e.to)-Math.max(o[t].x,e.from);1==this.isOk(o[t].y)?i.ok+=n:0==this.isOk(o[t].y)?i.ko+=n:i.none+=n}const a=i.ok/s*100,c=i.ko/s*100;return{ok:a,ko:c,none:100-(a+c)}}getUptimeSize(){const{hours_to_show:e}=this.config;return 36e5*e}getMinimumDate(){return(new Date).getTime()-this.getUptimeSize()}getColor(e){const{color:t}=this.config;return 1==this.isOk(e)?t.ok:0==this.isOk(e)?t.ko:t.none}getCssColor(e,t){var n;const r=1==e?this.getColor(null===(n=this.sensor)||void 0===n?void 0:n.state):t||void 0;return r?`color: ${r};`:""}async fetchRecent(e,t,n){let r="history/period";t&&(r+="/"+t.toISOString()),r+="?filter_entity_id="+e,n&&(r+="&end_time="+n.toISOString()),r+="&minimal_response";const o=await this._hass.callApi("GET",r);return o[0]?o[0].map(e=>({x:new Date(e.last_changed).getTime(),y:e.state})):[]}cleanPoints(e){const t=[];let n=void 0;for(const r of e)r.y!=n&&(t.push(r),n=r.y);return t}handleClick(e){e.stopPropagation(),this.config&&this._hass&&k(this,this._hass,this.config,!1,!1)}computeBarColor(e){const{severity:t,color:n,color_thresholds:r}=this.config;if(100==e.none)return n.none;if(r){const t=r.slice().sort((e,t)=>t.value-e.value).find(t=>t.value<=e.ok);return t?t.color:n.none}return 100==e.ok?n.ok:e.ko>=t?n.ko:n.half}attachBlink(e){var t;const n=this.config.blink;return this.isOk(null===(t=this.sensor)||void 0===t?void 0:t.state)||!n||e!=n.target||"card"!=n.target&&"shadow"==n.effect?"":`animation: blink-${n.effect} ${n.speed}s infinite;`}render(){const{bar:e}=this.config,t=[...Array(e.amount).keys()].map((e,t)=>{const n=this.findBarPeriod(t);return{period:n,repartition:this.findBarRepartition(n),index:t}});return ce`
        ...
        `}renderIcon(){var e,t;const{icon:n,ko_icon:r,show:o,icon_adaptive_color:i,color:s}=this.config,a=(0==this.isOk(null===(e=this.sensor)||void 0===e?void 0:e.state)&&r?r:n)||(null===(t=this.sensor)||void 0===t?void 0:t.attributes.icon)||"mdi:heart",c=(null==a?void 0:a.startsWith("/local"))||(null==a?void 0:a.startsWith("http"))?ce`
                      <div
                          class="icon-image"
                          style="background-image: url(${a}); background-size: cover; style=${this.attachBlink("icon")}"
                      ></div>
                  `:ce`
                  ...
                  <div
                      class="icon"
                      style="${this.getCssColor(i,s.icon)} ${this.attachBlink("icon")}"
                  >
                      ${c}
                  </div>
        ...
        ></rect>`}renderFooter(e){const{show:t}=this.config;return t.footer&&t.timeline?ce`
            ...
            <div class="line"></div>
        `}static get styles(){return Mt}};e([Se({attribute:!1})],Bt.prototype,"_hass",void 0),e([xe()],Bt.prototype,"config",void 0),e([xe()],Bt.prototype,"sensor",void 0),e([xe()],Bt.prototype,"interval",void 0),e([xe()],Bt.prototype,"cache",void 0),e([xe()],Bt.prototype,"tooltip",void 0),Bt=e([be("uptime-card")],Bt);export{Bt as UptimeCard};
