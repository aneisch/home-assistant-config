 ...
 */
const k="undefined"!=typeof window&&null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,N=(e,t,n=null)=>{for(;t!==n;){const n=t.nextSibling;e.removeChild(t),t=n}},C=`{{lit-${String(Math.random()).slice(2)}}}`,I=`\x3c!--${C}--\x3e`,O=new RegExp(`${C}|${I}`);class E{constructor(e,t){this.parts=[],this.element=t;const n=[],r=[],o=document.createTreeWalker(t.content,133,null,!1);let i=0,s=-1,a=0;const{strings:c,values:{length:l}}=e;for(;a<l;){const e=o.nextNode();if(null!==e){if(s++,1===e.nodeType){if(e.hasAttributes()){const t=e.attributes,{length:n}=t;let r=0;for(let e=0;e<n;e++)T(t[e].name,"$lit$")&&r++;for(;r-- >0;){const t=c[a],n=M.exec(t)[2],r=n.toLowerCase()+"$lit$",o=e.getAttribute(r);e.removeAttribute(r);const i=o.split(O);this.parts.push({type:"attribute",index:s,name:n,strings:i}),a+=i.length-1}}"TEMPLATE"===e.tagName&&(r.push(e),o.currentNode=e.content)}else if(3===e.nodeType){const t=e.data;if(t.indexOf(C)>=0){const r=e.parentNode,o=t.split(O),i=o.length-1;for(let t=0;t<i;t++){let n,i=o[t];if(""===i)n=D();else{const e=M.exec(i);null!==e&&T(e[2],"$lit$")&&(i=i.slice(0,e.index)+e[1]+e[2].slice(0,-"$lit$".length)+e[3]),n=document.createTextNode(i)}r.insertBefore(n,e),this.parts.push({type:"node",index:++s})}""===o[i]?(r.insertBefore(D(),e),n.push(e)):e.data=o[i],a+=i}}else if(8===e.nodeType)if(e.data===C){const t=e.parentNode;null!==e.previousSibling&&s!==i||(s++,t.insertBefore(D(),e)),i=s,this.parts.push({type:"node",index:s}),null===e.nextSibling?e.data="":(n.push(e),s--),a++}else{let t=-1;for(;-1!==(t=e.data.indexOf(C,t+1));)this.parts.push({type:"node",index:-1}),a++}}else o.currentNode=r.pop()}for(const e of n)e.parentNode.removeChild(e)}}const T=(e,t)=>{const n=e.length-t.length;return n>=0&&e.slice(n)===t},A=e=>-1!==e.index,D=()=>document.createComment(""),M=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function $(e,t){const{element:{content:n},parts:r}=e,o=document.createTreeWalker(n,133,null,!1);let i=R(r),s=r[i],a=-1,c=0;const l=[];let u=null;for(;o.nextNode();){a++;const e=o.currentNode;for(e.previousSibling===u&&(u=null),t.has(e)&&(l.push(e),null===u&&(u=e)),null!==u&&c++;void 0!==s&&s.index===a;)s.index=null!==u?-1:s.index-c,i=R(r,i),s=r[i]}l.forEach(e=>e.parentNode.removeChild(e))}const j=e=>{let t=11===e.nodeType?0:1;const n=document.createTreeWalker(e,133,null,!1);for(;n.nextNode();)t++;return t},R=(e,t=-1)=>{for(let n=t+1;n<e.length;n++){const t=e[n];if(A(t))return n}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class L{constructor(e,t,n){this.__parts=[],this.template=e,this.processor=t,this.options=n}update(e){let t=0;for(const n of this.__parts)void 0!==n&&n.setValue(e[t]),t++;for(const e of this.__parts)void 0!==e&&e.commit()}_clone(){const e=k?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),t=[],n=this.template.parts,r=document.createTreeWalker(e,133,null,!1);let o,i=0,s=0,a=r.nextNode();for(;i<n.length;)if(o=n[i],A(o)){for(;s<o.index;)s++,"TEMPLATE"===a.nodeName&&(t.push(a),r.currentNode=a.content),null===(a=r.nextNode())&&(r.currentNode=t.pop(),a=r.nextNode());if("node"===o.type){const e=this.processor.handleTextExpression(this.options);e.insertAfterNode(a.previousSibling),this.__parts.push(e)}else this.__parts.push(...this.processor.handleAttributeExpressions(a,o.name,o.strings,this.options));i++}else this.__parts.push(void 0),i++;return k&&(document.adoptNode(e),customElements.upgrade(e)),e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litElementVersions||(window.litElementVersions=[])).push("2.4.0");const Ie={};class Oe extends _e{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const e=this.getStyles();if(Array.isArray(e)){const t=(e,n)=>e.reduceRight((e,n)=>Array.isArray(n)?t(n,e):(e.add(n),e),n),n=t(e,new Set),r=[];n.forEach(e=>r.unshift(e)),this._styles=r}else this._styles=void 0===e?[]:[e];this._styles=this._styles.map(e=>{if(e instanceof CSSStyleSheet&&!Pe){const t=Array.prototype.slice.call(e.cssRules).reduce((e,t)=>e+t.cssText,"");return new Ne(String(t),ke)}return e})}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const e=this.constructor._styles;0!==e.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?Pe?this.renderRoot.adoptedStyleSheets=e.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e.map(e=>e.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(e){const t=this.render();super.update(e),t!==Ie&&this.constructor.render(t,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(e=>{const t=document.createElement("style");t.textContent=e.cssText,this.renderRoot.appendChild(t)}))}render(){return Ie}}Oe.finalized=!0,Oe.render=(e,t,n)=>{if(!n||"object"!=typeof n||!n.scopeName)throw new Error("The `scopeName` option is required.");const r=n.scopeName,o=se.has(t),i=de&&11===t.nodeType&&!!t.host,s=i&&!pe.has(r),a=s?document.createDocumentFragment():t;if(((e,t,n)=>{let r=se.get(t);void 0===r&&(N(t,t.firstChild),se.set(t,r=new Q(Object.assign({templateFactory:oe},n))),r.appendInto(t)),r.setValue(e),r.commit()})(e,a,Object.assign({templateFactory:he(r)},n)),s){const e=se.get(a);se.delete(a);const n=e.value instanceof L?e.value.template:void 0;me(r,a,n),N(t,t.firstChild),t.appendChild(a),se.set(t,e)}!o&&i&&window.ShadyCSS.styleElement(t.host)};const Ee={hours_to_show:24,severity:100,average_text:"%",status_template:"[[ current ]]",title_adaptive_color:!1,status_adaptive_color:!1,icon_adaptive_color:!1,tooltip_adaptive_color:!1},Te={ok:"#45C669",ko:"#C66445",half:"#C6B145",none:"#C9C9C9",title:"grey",status:"grey",tooltip:"grey"},Ae={header:!0,title:!0,icon:!0,status:!0,timeline:!0,footer:!0,average:!0},De={height:46,round:1,spacing:4,amount:36},Me={hour24:!1,template:"[[ from_date ]] - [[ to_date ]] | [[ average ]]%",animation:!0},$e={action:"more-info"},je={header:"spaced",icon_first:!1,status:"spaced",tooltip_first:!1};let Re=class extends Oe{constructor(){super(...arguments),this._initialized=!1}setConfig(e){this._config=e,this.loadCardHelpers()}shouldUpdate(){return this._initialized||this._initialize(),!0}render(){return this.hass&&this._helpers&&this.options?(this._helpers.importMoreInfoControl("climate"),ce`
        ...
        `}getPropertyValue(e){if(null==this._config)return;const t=e.section?this._config[e.section]:this._config;return null!=t?t[e.name]:void 0}_initialize(){var e,t,n,r,o,i,s,a,c;if(void 0===this.hass)return;if(void 0===this._config)return;if(void 0===this._helpers)return;this._initialized=!0;const l=Object.keys(this.hass.states),u=["more-info","url","navigate","toggle","call-service","fire-dom-event"],d=["center","right","left","spaced"];this.options={mandatory:{icon:"tune",name:"Mandatory",description:"Required options for this card to function",show:!0,properties:[{type:"dropdown",items:l,name:"entity",label:"Entity",selected:l.indexOf((null===(e=this._config)||void 0===e?void 0:e.entity)||"")}]},customization:{icon:"cog",name:"Global customization",description:"Customize the name, icon, etc",show:!1,properties:[{type:"input",name:"name",label:"Name"},{type:"input",name:"icon",label:"Icon"},{type:"input",name:"ko_icon",label:"KO Icon"},{type:"number",name:"severity",label:"Severity",min:0,max:100,default:Ee.severity},{type:"number",name:"hours_to_show",label:"Hours to show",min:1/60,max:8760,default:Ee.hours_to_show},{type:"input",name:"ok",label:"Ok status name"},{type:"input",name:"ko",label:"Ko status name"},{type:"input",name:"status_template",label:"The template of the status",default:Ee.status_template},{type:"input",name:"average_text",label:"Average text",default:Ee.average_text},{type:"switch",name:"title_adaptive_color",label:"Adaptive color for title",default:Ee.title_adaptive_color},{type:"switch",name:"status_adaptive_color",label:"Adaptive color for status",default:Ee.status_adaptive_color},{type:"switch",name:"icon_adaptive_color",label:"Adaptive color for icon",default:Ee.icon_adaptive_color},{type:"switch",name:"tooltip_adaptive_color",label:"Adaptive color for tooltip",default:Ee.tooltip_adaptive_color}]},bar:{icon:"chart-bar",name:"Bar customization",description:"Customize the bar style",show:!1,properties:[{type:"number",name:"height",section:"bar",label:"Height",min:4,max:200,default:De.height},{type:"number",name:"round",section:"bar",label:"Round corner ratio",min:0,max:100,default:De.round},{type:"number",name:"spacing",section:"bar",label:"Spacing",min:0,max:10,default:De.spacing},{type:"number",name:"amount",section:"bar",label:"Amount",min:1,max:100,default:De.amount}]},color:{icon:"palette",name:"Color customization",description:"Customize the color palette",show:!1,properties:[{type:"input",name:"ok",section:"color",label:"Ok's element color",default:Te.ok},{type:"input",name:"ko",section:"color",label:"Ko's element color",default:Te.ko},{type:"input",name:"none",section:"color",label:"Unknown's element color",default:Te.none},{type:"input",name:"half",section:"color",label:"Half's element color",default:Te.half},{type:"input",name:"title",section:"color",label:"Title text color",default:Te.title},{type:"input",name:"status",section:"color",label:"Status text color",default:Te.status},{type:"input",name:"icon",section:"color",label:"Icon color"},{type:"input",name:"tooltip",section:"color",label:"Tooltip text color",default:Te.tooltip}]},show:{icon:"eye",name:"Toggle elements",description:"Show or hide uptime card elements",show:!1,properties:[{type:"switch",name:"header",section:"show",label:"Toggle header",default:Ae.header},{type:"switch",name:"title",section:"show",label:"Toggle title",default:Ae.title},{type:"switch",name:"icon",section:"show",label:"Toggle icon",default:Ae.icon},{type:"switch",name:"status",section:"show",label:"Toggle status",default:Ae.status},{type:"switch",name:"timeline",section:"show",label:"Toggle timeline",default:Ae.timeline},{type:"switch",name:"footer",section:"show",label:"Toggle footer",default:Ae.footer},{type:"switch",name:"average",section:"show",label:"Toggle average",default:Ae.average}]},alias:{icon:"reload",name:"Alias",description:"Replace status name by alias",show:!1,properties:[{type:"input",name:"ok",section:"alias",label:"Alias for Ok status"},{type:"input",name:"ko",section:"alias",label:"Alias for Ko status"}]},tooltip:{icon:"tooltip-text",name:"Tooltip elements",description:"Handle tooltip information",show:!1,properties:[{type:"switch",name:"hour24",section:"tooltip",label:"Set to true to display times in 24-hour format.",default:Me.hour24},{type:"switch",name:"animation",section:"tooltip",label:"Set to true to show the animation.",default:Me.animation},{type:"input",name:"template",section:"tooltip",label:"Template of the tooltip.",default:Me.template}]},tap_action:{icon:"gesture-tap",name:"Tap action elements",description:"Handle tap action information",show:!1,properties:[{type:"dropdown",items:u,name:"action",section:"tap_action",label:"Action to perform.",selected:u.indexOf((null===(n=null===(t=this._config)||void 0===t?void 0:t.tap_action)||void 0===n?void 0:n.action)||$e.action)},{type:"input",name:"entity",section:"tap_action",label:"(Only for more-info) Override the entity for more information."},{type:"input",name:"navigation_path",section:"tap_action",label:"(Only for navigate) Path to navigate to (e.g. `/lovelace/0/`)."},{type:"input",name:"url_path",section:"tap_action",label:"(Only for url) URL to open."},{type:"input",name:"service",section:"tap_action",label:"(Only for call-service) Service to call."},{type:"input",name:"service-data",section:"tap_action",label:"(Only for call-service) Service data to include."},{type:"dropdown",items:["success","warning","failure","light","medium","heavy","selection"],name:"haptic",section:"tap_action",label:"Haptic feedback.",selected:u.indexOf((null===(o=null===(r=this._config)||void 0===r?void 0:r.tap_action)||void 0===o?void 0:o.haptic)||"")}]},alignment:{icon:"ruler",name:"Alignment",description:"Align elements from the card",show:!1,properties:[{type:"dropdown",items:d,name:"header",section:"alignment",label:"Alignment of the header.",selected:d.indexOf((null===(s=null===(i=this._config)||void 0===i?void 0:i.alignment)||void 0===s?void 0:s.header)||je.header)},{type:"switch",name:"icon_first",section:"alignment",label:"Set to true if the icon should be placed before the title.",default:je.icon_first},{type:"dropdown",items:d,name:"status",section:"alignment",label:"Alignment of the status.",selected:d.indexOf((null===(c=null===(a=this._config)||void 0===a?void 0:a.alignment)||void 0===c?void 0:c.status)||je.status)},{type:"switch",name:"tooltip_first",section:"alignment",label:"Set to true if the tooltip should be placed before the state.",default:je.tooltip_first}]}}}async loadCardHelpers(){this._helpers=await window.loadCardHelpers()}_toggleOption(e){if(null==this.options)return;const t=!this.options[e.target.option].show;for(const[e]of Object.entries(this.options))this.options[e].show=!1;this.options[e.target.option].show=t,this._toggle=!this._toggle}_valueChanged(e){if(!this._config||!this.hass)return;const t=e.target,n=t.configSection,r=Object.assign({},this._config),o=(n?Object.assign({},r[n]):r)||{};if(t.configValue)if(void 0===t.value&&void 0===t.checked||""===t.value)delete o[t.configValue],this._config=n?Object.assign(Object.assign({},r),{[n]:o}):Object.assign({},o);else{const e=t.configValue,o=void 0!==t.checked?t.checked:t.value,i=t.number?parseFloat(o):o;this._config=n?Object.assign(Object.assign({},r),{[n]:Object.assign(Object.assign({},r[n]),{[e]:i})}):Object.assign(Object.assign({},r),{[e]:i})}S(this,"config-changed",{config:this._config})}static get styles(){return Ce`
            .option {
                padding: 4px 0px;
                cursor: pointer;
            }
...
`,jt=(e,t)=>e.length>t?e.slice(0,t)+"...":e,Rt=(e,t,n)=>{const r=[...e.matchAll(/\[\[ ([a-zA-Z0-9_.-]*) \]\]/g)].map(e=>e[1]);return null==r||r.forEach(r=>{const o=`[[ ${r} ]]`,i=t[r];if(null!=i)e=e.replace(o,i);else if(null!=n&&r.startsWith(n.entity_id))if(n.entity_id==r)e=e.replace(o,n.entity_id);else{const t=r.replace(n.entity_id,"").split(".").slice(1);let i=n;for(const e of t){if(null==i||null==i[e]){i=void 0;break}i=i[e]}null!=i&&"object"!=typeof i&&(e=e.replace(o,String(i)))}}),e};console.info("%c uptime-card \n    0.3.0    ","color: white; background-color: #C6B145; font-weight: 700;"),window.customCards=window.customCards||[],window.customCards.push({type:"uptime-card",name:"Uptime Card",description:"The uptime card show you the history of your binary sensors in a cool way."});let Bt=class extends Oe{static async getConfigElement(){return document.createElement("uptime-card-editor")}static getStubConfig(){return{}}set hass(e){this._hass=e,this.sensor=e.states[this.config.entity],this.updateData()}get actions(){return["more-info","url"]}setConfig(e){if(!e)throw new Error("Invalid configuration !");this.config=Object.assign(Object.assign(Object.assign({},Ee),e),{color:Object.assign(Object.assign({},Te),e.color),alias:Object.assign({},e.alias),show:Object.assign(Object.assign({},Ae),e.show),bar:Object.assign(Object.assign({},De),e.bar),tooltip:Object.assign(Object.assign({},Me),e.tooltip),tap_action:Object.assign(Object.assign({},$e),e.tap_action),alignment:Object.assign(Object.assign({},je),e.alignment)}),this.updateData()}shouldUpdate(e){return!!this.config&&function(e,t,n){if(t.has("config")||n)return!0;if(e.config.entity){var r=t.get("hass");return!r||r.states[e.config.entity]!==e.hass.states[e.config.entity]}return!1}(this,e,!1)}firstUpdated(e){this.updateData()}connectedCallback(){super.connectedCallback(),this.config.update_interval&&(this.interval=setInterval(()=>this.updateData(),1e3*this.config.update_interval))}disconnectedCallback(){this.interval&&clearInterval(this.interval),super.disconnectedCallback()}async updateData(){if(null==this.config||null==this._hass)return;const{entity:e,hours_to_show:t}=this.config;if(this.sensor=this._hass.states[this.config.entity],null==this.sensor)return;const n=await this.getCache(e);null!=n&&(this.cache=n);const r=(new Date).getTime();let o;const i=null==n||n.hoursToShow<t,s=i?this.getMinimumDate():n.lastFetched,a=new Date(s),c=new Date;if(c.getTime()-a.getTime()<1e4)return;const l=await this.fetchRecent(e,a,c),u=i?l:[...n.points,...l],d=u.findIndex(e=>e.x>this.getMinimumDate()),h=0==d?u:u.slice(d-1),f=this.cleanPoints(h);if(f.length>0)o={points:f,lastFetched:r,lastChanged:f[f.length-1].x,hoursToShow:t};else{const e=new Date(this.sensor.last_changed).getTime();o={points:[{x:e,y:this.sensor.state}],lastFetched:r,lastChanged:e,hoursToShow:t}}await this.setCache(e,o),this.cache=o}async getCache(e){const t=await Mt.getItem(e);return null==t?(console.warn(`Can't load the key ${e} from cache.`),null):(n=t,JSON.parse(n));var n}async setCache(e,t){return Mt.setItem(e,(n=t,JSON.stringify(n)));var n}isOk(e){const{ok:t,ko:n,entity:r}=this.config;return null==e?void 0:t==e||n!=e&&(null==t&&null==n?null!=r&&r.startsWith("binary_sensor")?"on"==e||"off"!=e&&void 0:void 0:null==t)}findBarPeriod(e){const{bar:t}=this.config,n=this.getUptimeSize()/t.amount,r=(new Date).getTime()-(t.amount-1-e)*n;return{from:r-n+1,to:r}}findBarRepartition(e){const t={ok:0,ko:0,none:100};if(null==this.cache)return t;const n=this.cache.points.findIndex(t=>t.x>=e.from),r=this.cache.points.findIndex(t=>t.x>e.to);let o;if(0==this.cache.points.length)return t;if(-1==n)o=[this.cache.points[this.cache.points.length-1]];else{if(0==n&&0==r)return t;{const e=0==n?0:1,t=-1==r?this.cache.points.length:r;o=this.cache.points.slice(n-e,t)}}const i={ok:0,ko:0,none:0},s=e.to-e.from;for(let t=0;t<o.length;t++){const n=(o[t+1]?o[t+1].x:e.to)-Math.max(o[t].x,e.from);1==this.isOk(o[t].y)?i.ok+=n:0==this.isOk(o[t].y)?i.ko+=n:i.none+=n}const a=i.ok/s*100,c=i.ko/s*100;return{ok:a,ko:c,none:100-(a+c)}}getUptimeSize(){const{hours_to_show:e}=this.config;return 36e5*e}getMinimumDate(){return(new Date).getTime()-this.getUptimeSize()}getColor(e){const{color:t}=this.config;return 1==this.isOk(e)?t.ok:0==this.isOk(e)?t.ko:t.none}getCssColor(e,t){var n;const r=1==e?this.getColor(null===(n=this.sensor)||void 0===n?void 0:n.state):t||void 0;return r?`color: ${r};`:""}async fetchRecent(e,t,n){let r="history/period";t&&(r+="/"+t.toISOString()),r+="?filter_entity_id="+e,n&&(r+="&end_time="+n.toISOString()),r+="&minimal_response";const o=await this._hass.callApi("GET",r);return o[0]?o[0].map(e=>({x:new Date(e.last_changed).getTime(),y:e.state})):[]}cleanPoints(e){const t=[];let n=void 0;for(const r of e)r.y!=n&&(t.push(r),n=r.y);return t}handleClick(e){e.stopPropagation(),this.config&&this._hass&&P(this,this._hass,this.config,!1,!1)}render(){const{bar:e}=this.config,t=[...Array(e.amount).keys()].map((e,t)=>{const n=this.findBarPeriod(t);return{period:n,repartition:this.findBarRepartition(n),index:t}});return ce`
        ...
        `}renderHeader(){const{show:e,alignment:t}=this.config;return e.header?ce`
              ...
              `:ce``}renderTitle(){var e;const{name:t,color:n,title_adaptive_color:r,show:o}=this.config;let i=t;return null==i&&(i=(null===(e=this.sensor)||void 0===e?void 0:e.entity_id)||""),o.title?ce`
                  <div class="name">
                      <span style=${this.getCssColor(r,n.title)}>${jt(i,30)}</span>
                  </div>
              ...
              `:ce``}renderState(){const{alias:e,color:t,status_adaptive_color:n,status_template:r,ok:o,ko:i}=this.config;let s;s=null==this.sensor?"Unknown":1==this.isOk(this.sensor.state)&&e.ok?e.ok:0==this.isOk(this.sensor.state)&&e.ko?e.ko:null==this.isOk(this.sensor.state)?"Unknown":this.sensor.state;const a=Rt(r,{current:s,ok:e.ok||o||"[[ ok ]]",ko:e.ko||i||"[[ ko ]]"},this.sensor);return ce`
            <span style=${this.getCssColor(n,t.status)}>${jt(a,30)}</span>
        ...
        `}renderIcon(){var e,t;const{icon:n,ko_icon:r,show:o,icon_adaptive_color:i,color:s}=this.config,a=(0==this.isOk(null===(e=this.sensor)||void 0===e?void 0:e.state)&&r?r:n)||(null===(t=this.sensor)||void 0===t?void 0:t.attributes.icon)||"mdi:heart";return o.icon?ce`
                  <div class="icon flex" style=${this.getCssColor(i,s.icon)}>
                      <ha-icon .icon=${a}></ha-icon>
                  </div>
              `:""}renderTimeline(e){const{show:t,color:n,bar:r,severity:o,tooltip:i}=this.config,s=0==t.status||0==i.animation,a=s?r.height:r.height+5,c=r.spacing*(r.amount-1),l=Math.floor((500-c)/r.amount),u=500-c-l*r.amount;if(0==t.timeline)return"";const d=e.map((e,t)=>{var i;let a;a=100==e.repartition.none?n.none:100==e.repartition.ok?n.ok:e.repartition.ko>=o?n.ko:n.half;const c=(null===(i=this.tooltip)||void 0===i?void 0:i.index)!=t||s,d=c?r.height:r.height+5,h=s?0:c?5:0;return this.renderBar(t*(l+r.spacing)+u/2,h,l,d,a,r.round,e)});return ce`
            <div class="timeline">
                <svg width="100%" height="100%" } viewBox="0 0 ${500} ${a}">
                    ${d}
                </svg>
            </div>
        ...
        ></rect>`}renderFooter(e){const{show:t}=this.config;return t.footer&&t.timeline?ce`
              ...
              `:ce``}renderAverage(e){const{show:t,average_text:n}=this.config,r=(e.reduce((e,t)=>e+t.ok,0)/e.length).toFixed(2);return t.average?ce`
            ...
            <div class="line"></div>
        `}static get styles(){return $t}};e([Se({attribute:!1})],Bt.prototype,"_hass",void 0),e([xe()],Bt.prototype,"config",void 0),e([xe()],Bt.prototype,"sensor",void 0),e([xe()],Bt.prototype,"interval",void 0),e([xe()],Bt.prototype,"cache",void 0),e([xe()],Bt.prototype,"tooltip",void 0),Bt=e([be("uptime-card")],Bt);export{Bt as UptimeCard};
