import{i as e,s as i,_ as t,n,t as a,a as s,x as o,e as r,l,r as c,b as d,c as u,d as m,p as h,f as _,g,h as b,j as p,k as v,C as f,m as $,o as y,q as w,u as S,v as x,w as M,y as I,z as k,A as O,B as C,D as z,E as A,F as N,G as T,H as B,I as E,J as P,K as H,L,M as V,N as K,O as U,P as j,S as q,Q as R,R as D,Z as F,T as G,U as J,V as Q,W,X,Y,$ as Z,a0 as ee,a1 as ie,a2 as te,a3 as ne,a4 as ae,a5 as se,a6 as oe,a7 as re,a8 as le,a9 as ce,aa as de,ab as ue,ac as me,ad as he,ae as _e,af as ge,ag as be,ah as pe,ai as ve,aj as fe,ak as $e,al as ye,am as we,an as Se,ao as xe,ap as Me,aq as Ie,ar as ke,as as Oe,at as Ce,au as ze,av as Ae,aw as Ne,ax as Te,ay as Be,az as Ee,aA as Pe,aB as He,aC as Le,aD as Ve,aE as Ke,aF as Ue,aG as je,aH as qe,aI as Re,aJ as De,aK as Fe,aL as Ge,aM as Je,aN as Qe,aO as We,aP as Xe,aQ as Ye,aR as Ze,aS as ei,aT as ii,aU as ti,aV as ni,aW as ai,aX as si,aY as oi,aZ as ri,a_ as li,a$ as ci,b0 as di,b1 as ui,b2 as mi,b3 as hi,b4 as _i,b5 as gi,b6 as bi,b7 as pi,b8 as vi,b9 as fi,ba as $i,bb as yi,bc as wi,bd as Si,be as xi,bf as Mi,bg as Ii,bh as ki,bi as Oi,bj as Ci,bk as zi,bl as Ai,bm as Ni,bn as Ti,bo as Bi,bp as Ei,bq as Pi,br as Hi,bs as Li,bt as Vi,bu as Ki,bv as Ui,bw as ji,bx as qi,by as Ri,bz as Di,bA as Fi,bB as Gi,bC as Ji,bD as Qi,bE as Wi,bF as Xi,bG as Yi,bH as Zi,bI as et,bJ as it,bK as tt,bL as nt,bM as at,bN as st,bO as ot,bP as rt,bQ as lt,bR as ct,bS as dt,bT as ut,bU as mt,bV as ht,bW as _t,bX as gt,bY as bt,bZ as pt,b_ as vt,b$ as ft,c0 as $t,c1 as yt,c2 as wt,c3 as St,c4 as xt,c5 as Mt,c6 as It,c7 as kt,c8 as Ot,c9 as Ct,ca as zt,cb as At,cc as Nt,cd as Tt,ce as Bt,cf as Et,cg as Pt,ch as Ht,ci as Lt,cj as Vt,ck as Kt,cl as Ut,cm as jt,cn as qt,co as Rt,cp as Dt,cq as Ft,cr as Gt,cs as Jt,ct as Qt,cu as Wt,cv as Xt,cw as Yt,cx as Zt,cy as en,cz as tn,cA as nn,cB as an,cC as sn,cD as on,cE as rn,cF as ln,cG as cn,cH as dn,cI as un,cJ as mn,cK as hn,cL as _n,cM as gn,cN as bn,cO as pn,cP as vn,cQ as fn,cR as $n,cS as yn,cT as wn,cU as Sn,cV as xn}from"./card-937acef1.js";class Mn{constructor(e){this._assigning=!1,this._value=null,this._blurEventHandler=()=>{this._setAssigning(!1)},this._keydownEventHandler=e=>{e.key&&!["Control","Alt","Shift","Meta"].includes(e.key)&&(this.setValue({key:e.key,ctrl:e.ctrlKey,alt:e.altKey,shift:e.shiftKey,meta:e.metaKey}),this._setAssigning(!1))},this._host=e,this._host.addController(this)}setValue(i){e(i,this._value)||(this._value=i,this._host.requestUpdate(),this._host.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this._value}})))}getValue(){return this._value}hasValue(){return!!this._value}isAssigning(){return this._assigning}toggleAssigning(){this._setAssigning(!this._assigning)}_setAssigning(e){this._assigning=e,i(this._host,this._assigning,"assigning"),this._assigning?this._host.addEventListener("keydown",this._keydownEventHandler):this._host.removeEventListener("keydown",this._keydownEventHandler),this._host.requestUpdate()}hostConnected(){this._host.addEventListener("blur",this._blurEventHandler)}hostDisconnected(){this._host.removeEventListener("blur",this._blurEventHandler)}}let In=class extends s{constructor(){super(...arguments),this._controller=new Mn(this)}willUpdate(e){e.has("value")&&this._controller.setValue(this.value??null)}render(){if(!this.label)return;const e=e=>o`<div class="key">
    ...
    ></advanced-camera-card-key-assigner>`}_renderViewKeyboardShortcutMenu(){return this._putInSubmenu("view.keyboard_shortcuts",!0,`config.${T}.editor_label`,"mdi:keyboard",o`
      ...
      ${s?o`<div class="values">${a}</div>`:""}
        ...
        ${this._renderNumberInput(u,{min:F,max:G,label:l("config.cameras.dimensions.layout.zoom"),step:.1})}
      ...
      ${this._renderOptionSelector(i,this._timelineStyleTypes,{label:l(`config.common.${J}`)})}
      ${u?this._renderOptionSelector(u,this._timelinePanModes,{label:l("config.common.controls.timeline.pan_mode")}):""}
      ${this._renderNumberInput(t,{label:l(`config.common.${Q}`)})}
      ${this._renderNumberInput(n,{label:l(`config.common.${W}`)})}
      ${this._renderOptionSelector(a,this._timelineEventsMediaTypes,{label:l(`config.common.${X}`)})}
      ${this._renderSwitch(s,c,{label:l(`config.common.${Y}`)})}
    ...
    `}_renderMiniTimeline(e,i,t,n,a,s,r,c,d,u,m){return this._putInSubmenu(e,!0,"config.common.controls.timeline.editor_label","mdi:chart-gantt",o` ${this._renderOptionSelector(i,this._miniTimelineModes,{label:l("config.common.controls.timeline.mode")})}
      ...
      `)}_renderNextPreviousControls(e,i,t,n){return this._putInSubmenu(e,!0,"config.common.controls.next_previous.editor_label","mdi:arrow-right-bold-circle",o`
        ...
        ${this._renderNumberInput(t,{min:Z,label:l("config.common.controls.next_previous.size")})}
      `)}_renderThumbnailsControls(e,i,t,n,a,s,r,c){return this._putInSubmenu(e,!0,"config.common.controls.thumbnails.editor_label","mdi:image-text",o`
        ...
        ${this._renderNumberInput(i,{min:ee,max:ie,label:l("config.common.controls.thumbnails.size")})}
    ...
    `}_renderCamera(e,i,t,n){const a=[{value:"",label:""},{value:"auto",label:l("config.cameras.live_providers.auto")},{value:"ha",label:l("config.cameras.live_providers.ha")},{value:"image",label:l("config.cameras.live_providers.image")},{value:"jsmpeg",label:l("config.cameras.live_providers.jsmpeg")},{value:"go2rtc",label:l("config.cameras.live_providers.go2rtc")},{value:"webrtc-card",label:l("config.cameras.live_providers.webrtc-card")}],s=[];e.forEach(((e,t)=>{t!==i&&s.push({value:te(e),label:this._getEditorCameraTitle(t,e)})}));const c=e=>{if(this._config){const i=u(this._config);e(i)&&this._updateConfig(i)}},d={submenu:!0,selected:this._expandedMenus[kn]===i};return o`
      <div class="${r(d)}">
        <div
          class="submenu-header"
          @click=${this._toggleMenu}
        ...
        ${this._expandedMenus[kn]===i?o` <div class="values">
              <div class="controls">
                <ha-icon-button
                  ...
                  @click=${()=>!n&&c((e=>!!(Array.isArray(e.cameras)&&i>0)&&($t(e.cameras,i,i-1),this._openMenu(kn,i-1),!0)))}
                >
                  <advanced-camera-card-icon
                ...
                <ha-icon-button
                  ...
                  @click=${()=>!n&&c((e=>!!(Array.isArray(e.cameras)&&i<e.cameras.length-1)&&($t(e.cameras,i,i+1),this._openMenu(kn,i+1),!0)))}
                >
                  <advanced-camera-card-icon
                ...
                <ha-icon-button
                  ...
                  .disabled=${n}
                  @click=${()=>{c((e=>!!Array.isArray(e.cameras)&&(e.cameras.splice(i,1),this._closeMenu(kn),!0)))}}
                >
                  <advanced-camera-card-icon
              ...
              ${this._renderEntitySelector(ne(yt,i),"camera")}
              ${this._renderOptionSelector(ne(wt,i),a)}
              ${this._renderStringInput(ne(St,i))}
              ${this._renderIconSelector(ne(xt,i),{label:l("config.cameras.icon")})}
              ${this._renderStringInput(ne(Mt,i))}
              ${this._renderSwitch(ne(It,i),this._defaults.cameras.always_error_if_entity_unavailable)}
              ${this._putInSubmenu("cameras.engine",!0,"config.cameras.engines.editor_label","mdi:engine",o`${this._putInSubmenu("cameras.frigate",i,"config.cameras.frigate.editor_label","frigate",o`
                    ...
                    ${this._renderOptionSelector(ne(Ct,i),[],{multiple:!0,label:l("config.cameras.frigate.labels")})}
                    ${this._renderOptionSelector(ne(zt,i),[],{multiple:!0,label:l("config.cameras.frigate.zones")})}
                    ${this._renderStringInput(ne(At,i))}
                  `)}
                ${this._putInSubmenu("cameras.motioneye",i,"config.cameras.motioneye.editor_label","motioneye",o` ${this._renderStringInput(ne(Nt,i))}
                  ${this._renderStringInput(ne(Tt,i))}
                  ${this._renderStringInput(ne(Bt,i))}
                  ${this._renderStringInput(ne(Et,i))}
                  ${this._renderStringInput(ne(Pt,i))}`)}
                ${this._putInSubmenu("cameras.reolink",i,"config.cameras.reolink.editor_label","reolink",o` ${this._renderStringInput(ne(Ht,i))}
                  ${this._renderOptionSelector(ne(Lt,i),this._reolinkMediaResolution,{label:l("config.cameras.reolink.media_resolution.editor_label")})}`)}`)}
              ${this._putInSubmenu("cameras.live_provider",!0,"config.cameras.live_provider_options.editor_label","mdi:cctv",o` ${this._putInSubmenu("cameras.go2rtc",i,"config.cameras.go2rtc.editor_label","mdi:alpha-g-circle",o`${this._renderOptionSelector(ne(Vt,i),this._go2rtcModes,{multiple:!0,label:l("config.cameras.go2rtc.modes.editor_label")})}
                  ${this._renderStringInput(ne(Kt,i))}
                  ${this._renderStringInput(ne(Ut,i))} `)}
                ${this._putInSubmenu("cameras.image",!0,"config.cameras.image.editor_label","mdi:image",this._renderImageOptions(ne(jt,i),ne(qt,i),ne(Rt,i),ne(Dt,i),ne(Ft,i)))}
                ${this._putInSubmenu("cameras.webrtc_card",i,"config.cameras.webrtc_card.editor_label","mdi:webrtc",o`${this._renderEntitySelector(ne(Gt,i),"camera")}
                  ${this._renderStringInput(ne(Jt,i))}`)}`)}
              ${this._putInSubmenu("cameras.dependencies",i,"config.cameras.dependencies.editor_label","mdi:graph",o` ${this._renderSwitch(ne(Qt,i),this._defaults.cameras.dependencies.all_cameras)}
                ${this._renderOptionSelector(ne(Wt,i),s,{multiple:!0})}`)}
              ${this._putInSubmenu("cameras.triggers",i,"config.cameras.triggers.editor_label","mdi:magnify-scan",o`
                  ${this._renderSwitch(ne(Xt,i),this._defaults.cameras.triggers.occupancy)}
                  ${this._renderSwitch(ne(Yt,i),this._defaults.cameras.triggers.motion)}
                  ${this._renderOptionSelector(ne(Zt,i),t,{multiple:!0})}
                  ${this._renderOptionSelector(ne(en,i),this._triggersEvents,{multiple:!0,label:l("config.cameras.triggers.events.editor_label")})}
                `)}
              ${this._putInSubmenu("cameras.cast",i,"config.cameras.cast.editor_label","mdi:cast",o`
                  ${this._renderOptionSelector(ne(tn,i),this._castMethods)}
                  ${this._renderStringInput(ne(nn,i))}
                  ${this._renderStringInput(ne(an,i))}
                `)}
              ${this._putInSubmenu("cameras.dimensions",i,"config.cameras.dimensions.editor_label","mdi:aspect-ratio",o`
                  ${this._renderStringInput(ne(sn,i))}
                  ${this._renderMediaLayout("cameras.dimensions.layout","config.cameras.dimensions.layout.editor_label",ne(on,i),ne(rn,i),ne(ln,i),ne(cn,i),ne(dn,i),ne(un,i),ne(mn,i),ne(hn,i),ne(_n,i),ne(gn,i))}
                `)}
              ${this._putInSubmenu("cameras.capabilities",i,"config.cameras.capabilities.editor_label","mdi:cog-stop",o`
                  ${this._renderOptionSelector(ne(bn,i),this._capabilities,{multiple:!0})}
                  ${this._renderOptionSelector(ne(pn,i),this._capabilities,{multiple:!0})}
                `)}
              ${this._putInSubmenu("cameras.proxy",i,"config.cameras.proxy.editor_label","mdi:arrow-decision",o`
                  ${this._renderOptionSelector(ne(vn,i),this._proxyMedia,{label:l("config.cameras.proxy.media.editor_label")})}
                  ${this._renderSwitch(ne(fn,i),this._defaults.cameras.proxy.dynamic)}
                  ${this._renderOptionSelector(ne($n,i),this._proxySSLVerification,{label:l("config.cameras.proxy.ssl_verification.editor_label")})}
                  ${this._renderOptionSelector(ne(yn,i),this._proxySSLCiphers,{label:l("config.cameras.proxy.ssl_ciphers.editor_label")})}
                `)}
            </div>`:""}
      </div>
    ...
    `}_updateConfig(e){this._config=e,ae(this,"config-changed",{config:this._config})}render(){if(!this.hass||!this._config)return o``;const e=x(this.hass),i=b(this._config,wn)||[];return o`
      ${this._configUpgradeable?o` <div class="upgrade">
              ...
              <span>
                <mwc-button
                  ...
                  @click=${()=>{if(this._config){const e=u(this._config);se(e),this._updateConfig(e)}}}
                >
                </mwc-button>
              </span>
            </div>
      ...
      <div class="card-config">
        ...
        ${"cameras"===this._expandedMenus[On]?o`
              <div class="values">
        ...
        ${"profiles"===this._expandedMenus[On]?o` <div class="values">
              ${this._renderOptionSelector(oe,this._profiles,{multiple:!0,label:l("config.profiles.editor_label")})}
            </div>`:""}
        ${this._renderOptionSetHeader("view")}
        ${"view"===this._expandedMenus[On]?o`
              <div class="values">
                ${this._renderOptionSelector(re,this._viewModes)}
                ${this._renderOptionSelector(le,this._cameraSelectViewModes)}
                ${this._renderSwitch(ce,this._defaults.view.dim)}
                ${this._renderNumberInput(de)}
                ${this._renderSwitch(ue,this._defaults.view.default_cycle_camera)}
                ${this._renderViewDefaultResetMenu()} ${this._renderViewTriggersMenu()}
                ${this._renderViewKeyboardShortcutMenu()}
                ${this._renderOptionSelector(me,this._themes,{label:l("config.view.theme.themes.editor_label"),multiple:!0})}
              </div>
            `:""}
        ${this._renderOptionSetHeader("menu")}
        ${"menu"===this._expandedMenus[On]?o`
              <div class="values">
                ${this._renderOptionSelector(he,this._menuStyles)}
                ${this._renderOptionSelector(_e,this._menuPositions)}
                ${this._renderOptionSelector(ge,this._menuAlignments)}
                ${this._renderNumberInput(be,{min:Z})}
        ...
        ${"status_bar"===this._expandedMenus[On]?o`
              <div class="values">
                ${this._renderOptionSelector(pe,this._statusBarStyles)}
                ${this._renderOptionSelector(ve,this._statusBarPositions)}
                ${this._renderNumberInput(fe,{min:$e,label:l("config.status_bar.height")})}
                ${this._renderNumberInput(ye,{min:0,max:60,default:this._defaults.status_bar.popup_seconds,label:l("config.status_bar.popup_seconds")})}
        ...
        ${"live"===this._expandedMenus[On]?o`
              <div class="values">
                ${this._renderSwitch(we,this._defaults.live.preload)}
                ${this._renderSwitch(Se,this._defaults.live.draggable)}
                ${this._renderSwitch(xe,this._defaults.live.zoomable)}
                ${this._renderSwitch(Me,this._defaults.live.lazy_load)}
                ...
                ${this._renderOptionSelector(Oe,this._mediaActionNegativeConditions,{multiple:!0})}
                ${this._renderOptionSelector(Ce,this._mediaLiveMuteConditions,{multiple:!0})}
                ${this._renderOptionSelector(ze,this._mediaLiveUnmuteConditions,{multiple:!0})}
                ${this._renderOptionSelector(Ae,this._transitionEffects)}
                ${this._renderSwitch(Ne,this._defaults.live.show_image_during_load)}
                ${this._renderViewDisplay("live.display",Te,Be,Ee,Pe,He)}
                ${this._putInSubmenu("live.controls",!0,"config.live.controls.editor_label","mdi:gamepad",o`
                    ${this._renderSwitch(Le,this._defaults.live.controls.builtin,{label:l("config.common.controls.builtin")})}
                    ${this._renderNextPreviousControls("live.controls.next_previous",Ve,Ke,{allowIcons:!0})}
                    ${this._renderThumbnailsControls("live.controls.thumbnails",Ue,je,qe,Re,De,this._defaults.live.controls.thumbnails,{configPathMediaType:Fe,configPathEventsMediaType:Ge,configPathMode:Je})}
                    ${this._renderMiniTimeline("live.controls.timeline",Qe,We,Xe,Ye,Ze,ei,ii,this._defaults.live.controls.timeline.show_recordings,this._defaults.live.controls.timeline.format["24h"],ti)}
                    ${this._putInSubmenu("live.controls.ptz",!0,"config.live.controls.ptz.editor_label","mdi:pan",o`
                        ${this._renderOptionSelector(ni,this._ptzModes)}
                        ${this._renderOptionSelector(ai,this._ptzPositions)}
                        ${this._renderOptionSelector(si,this._ptzOrientations)}
                        ${this._renderSwitch(oi,this._defaults.live.controls.ptz.hide_pan_tilt,{label:l("config.live.controls.ptz.hide_pan_tilt")})}
                        ${this._renderSwitch(ri,this._defaults.live.controls.ptz.hide_pan_tilt,{label:l("config.live.controls.ptz.hide_zoom")})}
                        ${this._renderSwitch(li,this._defaults.live.controls.ptz.hide_home,{label:l("config.live.controls.ptz.hide_home")})}
                      `)}
                  `)}
                ${this._putInSubmenu("live.microphone",!0,"config.live.microphone.editor_label","mdi:microphone",o`
                    ${this._renderNumberInput(ci)}
                    ${this._renderSwitch(di,this._defaults.live.microphone.always_connected)}
                    ${this._renderNumberInput(ui)}
                  `)}
              </div>
            `:""}
        ${this._renderOptionSetHeader("media_gallery")}
        ${"media_gallery"===this._expandedMenus[On]?o` <div class="values">
              ${this._renderThumbnailsControls("media_gallery.controls.thumbnails",mi,hi,_i,gi,bi,this._defaults.media_gallery.controls.thumbnails)}
              ${this._renderFilterControls("media_gallery.controls.filter",pi)}
            </div>`:""}
        ${this._renderOptionSetHeader("media_viewer")}
        ${"media_viewer"===this._expandedMenus[On]?o` <div class="values">
              ${this._renderOptionSelector(vi,this._mediaActionPositiveConditions,{multiple:!0})}
              ${this._renderOptionSelector(fi,this._mediaActionNegativeConditions,{multiple:!0})}
              ${this._renderOptionSelector($i,this._mediaActionNegativeConditions,{multiple:!0})}
              ${this._renderOptionSelector(yi,this._mediaActionPositiveConditions,{multiple:!0})}
              ${this._renderSwitch(wi,this._defaults.media_viewer.draggable)}
              ${this._renderSwitch(Si,this._defaults.media_viewer.zoomable)}
              ${this._renderSwitch(xi,this._defaults.media_viewer.lazy_load)}
              ${this._renderOptionSelector(Mi,this._transitionEffects)}
              ${this._renderSwitch(Ii,this._defaults.media_viewer.snapshot_click_plays_clip)}
              ${this._renderViewDisplay("media_viewer.display",ki,Oi,Ci,zi,Ai)}
              ${this._putInSubmenu("media_viewer.controls",!0,"config.media_viewer.controls.editor_label","mdi:gamepad",o`
                  ${this._renderSwitch(Ni,this._defaults.media_viewer.controls.builtin,{label:l("config.common.controls.builtin")})}
                  ${this._renderNextPreviousControls("media_viewer.controls.next_previous",Ti,Bi,{allowThumbnails:!0})}
                  ${this._renderThumbnailsControls("media_viewer.controls.thumbnails",Ei,Pi,Hi,Li,Vi,this._defaults.media_viewer.controls.thumbnails,{configPathMode:Ki})}
                  ${this._renderMiniTimeline("media_viewer.controls.timeline",Ui,ji,qi,Ri,Di,Fi,Gi,this._defaults.media_viewer.controls.timeline.show_recordings,this._defaults.media_viewer.controls.timeline.format["24h"],Ji)}
                `)}
            </div>`:""}
        ${this._renderOptionSetHeader("image")}
        ${"image"===this._expandedMenus[On]?o` <div class="values">
              ${this._renderImageOptions(Qi,Wi,Xi,Yi,Zi)}
            </div>`:""}
        ${this._renderOptionSetHeader("timeline")}
        ${"timeline"===this._expandedMenus[On]?o` <div class="values">
              ${this._renderTimelineCoreControls("timeline.format",J,Q,W,X,Y,et,this._defaults.timeline.show_recordings,this._defaults.timeline.format["24h"])}
              ${this._renderThumbnailsControls("timeline.controls.thumbnails",it,tt,nt,at,st,this._defaults.timeline.controls.thumbnails,{configPathMode:ot})}
            </div>`:""}
        ${this._renderOptionSetHeader("dimensions")}
        ${"dimensions"===this._expandedMenus[On]?o` <div class="values">
              ${this._renderOptionSelector(rt,this._aspectRatioModes)}
              ${this._renderStringInput(lt)}
              ${this._renderStringInput(ct)}
            </div>`:""}
        ${this._renderOptionSetHeader("performance","low"===b(this._config,Sn)?"warning":void 0)}
        ${"performance"===this._expandedMenus[On]?o` <div class="values">
              ${"low"===b(this._config,Sn)?this._renderInfo(l("config.performance.warning")):o``}
              ${this._putInSubmenu("performance.features",!0,"config.performance.features.editor_label","mdi:feature-search",o`
                  ${this._renderSwitch(dt,this._defaults.performance.features.card_loading_indicator)}
                  ${this._renderSwitch(ut,this._defaults.performance.features.animated_progress_indicator)}
                  ${this._renderNumberInput(mt,{max:ht})}
                  ${this._renderNumberInput(_t,{min:1})}
                `)}
              ${this._putInSubmenu("performance.style",!0,"config.performance.style.editor_label","mdi:palette-swatch-variant",o`
                  ${this._renderSwitch(gt,this._defaults.performance.style.border_radius)}
                  ${this._renderSwitch(bt,this._defaults.performance.style.box_shadow)}
                `)}
            </div>`:""}
        ${this._renderOptionSetHeader("remote_control")}
        ${"remote_control"===this._expandedMenus[On]?o` <div class="values">
              ${this._putInSubmenu("remote_control.entities",!0,"config.remote_control.entities.editor_label","mdi:devices",o`
                  ${this._renderEntitySelector(pt,"input_select")}
                `)}
            </div>`:""}
        ${void 0!==this._config.overrides?o` ${this._renderOptionSetHeader("overrides")}
            ${"overrides"===this._expandedMenus[On]?o` <div class="values">
                  ${this._renderInfo(l("config.overrides.info"))}
                </div>`:""}`:o``}
      </div>
    `}_closeMenu(e){delete this._expandedMenus[e],this.requestUpdate()}_openMenu(e,i){this._expandedMenus[e]=i,this.requestUpdate()}_toggleMenu(e){if(e&&e.target){const i=e.target.domain,t=e.target.key;this._expandedMenus[i]===t?this._closeMenu(i):this._openMenu(i,t)}}_valueChangedHandler(e,i){if(!this._config||!this.hass)return;let t;if(i.detail&&void 0!==i.detail.value&&(t=i.detail.value,"string"==typeof t&&(t=t.trim())),b(this._config,e)===t)return;const n=u(this._config);""===t||void 0===t?vt(n,e):ft(n,e,t),this._updateConfig(n)}static get styles(){return c('ha-icon-button {\n  color: var(--advanced-camera-card-button-color);\n  background-color: var(--advanced-camera-card-button-background);\n  border-radius: 50%;\n  padding: 0px;\n  margin: 3px;\n  --ha-icon-display: block;\n  /* Buttons can always be clicked */\n  pointer-events: auto;\n}\n\n.option {\n  padding: 4px 4px;\n  cursor: pointer;\n}\n\n.option.option-overrides .title {\n  color: var(--warning-color);\n}\n\n.row {\n  display: flex;\n  margin-bottom: -14px;\n  pointer-events: none;\n}\n\n.title {\n  padding-left: 16px;\n  margin-top: -6px;\n  pointer-events: none;\n}\n\n.title.warning {\n  color: var(--warning-color);\n}\n\n.secondary {\n  padding-left: 40px;\n  color: var(--secondary-text-color);\n  pointer-events: none;\n}\n\n.values {\n  background: var(--secondary-background-color);\n  display: grid;\n}\n\n.values + .option,\n.submenu + .option {\n  margin-top: 10px;\n}\n\ndiv.upgrade {\n  width: auto;\n  border: 1px dotted var(--primary-color);\n  margin: 10px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n\ndiv.upgrade span {\n  padding: 10px;\n}\n\n.submenu-header {\n  display: flex;\n  padding: 10px;\n  cursor: pointer;\n}\n\n.submenu.selected > .submenu-header {\n  background-color: var(--primary-color);\n  color: var(--primary-text-color);\n}\n\n.submenu-header * {\n  flex-basis: auto;\n  pointer-events: none;\n}\n\n.submenu-header .new-camera {\n  font-style: italic;\n}\n\n.submenu:not(.selected) > .submenu-header .new-camera {\n  color: var(--secondary-text-color, "black");\n}\n\n.submenu-header advanced-camera-card-icon {\n  margin-right: 15px;\n}\n\n.submenu.selected {\n  border: 1px solid var(--primary-color);\n}\n\n.submenu {\n  width: calc(100% - 20px);\n  margin-left: auto;\n  margin-right: auto;\n  margin-bottom: 10px;\n}\n\n.submenu:first-child,\n:not(.submenu) + .submenu {\n  margin-top: 10px;\n}\n\n.submenu .controls {\n  display: inline-block;\n  margin-left: auto;\n  margin-right: 0px;\n  margin-bottom: 5px;\n}\n\n.submenu .controls ha-icon-button {\n  --mdc-icon-button-size: 32px;\n  --mdc-icon-size: calc(var(--mdc-icon-button-size) / 2);\n}\n\nspan.info {\n  padding: 10px;\n}\n\nha-selector {\n  padding: 10px;\n  border: 1px solid var(--divider-color);\n}')}};t([n({attribute:!1})],zn.prototype,"hass",void 0),t([d()],zn.prototype,"_config",void 0),t([d()],zn.prototype,"_defaults",void 0),t([d()],zn.prototype,"_expandedMenus",void 0),zn=t([a("advanced-camera-card-editor")],zn);export{zn as AdvancedCameraCardEditor};
