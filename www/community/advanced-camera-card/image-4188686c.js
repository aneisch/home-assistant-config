import{a,d2 as e,x as t,d5 as r,r as i,dc as s,_ as d,n,t as o}from"./card-eed141c1.js";import"./image-updating-player-d7635f52.js";let c=class extends a{constructor(){super(...arguments),this._refImage=e()}async getMediaPlayerController(){return await this.updateComplete,await(this._refImage.value?.getMediaPlayerController())??null}render(){if(this.hass&&this.cameraConfig)return t`
