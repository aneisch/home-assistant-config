import{dn as e,cT as t,x as s,d2 as a,dy as i,dz as r,dA as o,dx as d,r as h,eR as n,_ as l,t as c,eG as p,eJ as u,cP as y,a as m,cQ as _,cU as f,n as v}from"./card-5c354d47.js";import{c as g,e as $}from"./ha-hls-player-ace385c0.js";import{s as b,d as w,h as R,c as L}from"./media-ccb0cb67.js";import{m as P}from"./audio-cf3a75aa.js";customElements.whenDefined("ha-web-rtc-player").then((()=>{let p=class extends(customElements.get("ha-web-rtc-player")){async play(){return this._video?.play()}async pause(){this._video?.pause()}async mute(){this._video&&(this._video.muted=!0)}async unmute(){this._video&&(this._video.muted=!1)}isMuted(){return this._video?.muted??!0}async seek(e){this._video&&(this._video.currentTime=e)}async setControls(e){this._video&&b(this._video,e??this.controls)}isPaused(){return this._video?.paused??!0}async getScreenshotURL(){return this._video?e(this._video):null}render(){return this._error?(w(this),t({type:"error",message:this._error,context:{entity_id:this.entityid}})):s`
        <video
          ...
          @pause=${()=>o(this)}
        ></video>
      `}_loadedDataHandler(e){super._loadedData(),d(this,e,{player:this,capabilities:{supportsPause:!0,hasAudio:P(this._video)},technology:["webrtc"]})}static get styles(){return[super.styles,h(g),n`
          :host {
            width: 100%;
            height: 100%;
          }
      ...
      .muted=${!0}
    >
    </frigate-card-ha-camera-stream>`}static get styles(){return h(":host {\n  width: 100%;\n  height: 100%;\n  display: block;\n}")}};l([v({attribute:!1})],I.prototype,"hass",void 0),l([v({attribute:!1})],I.prototype,"cameraConfig",void 0),l([v({attribute:!0,type:Boolean})],I.prototype,"controls",void 0),I=l([c("frigate-card-live-ha")],I);export{I as FrigateCardLiveHA};
